...
if(!empty($_POST))
{
	if($word->existsData($_POST))
	{
		try
		{
			...
			$sql = "INSERT INTO m_products (product_name, created) VALUES (?,?)";
			$stmt = $pdo->prepare($sql);
			$valueArray = array($_POST["product_name"],$now);
	...
	<div class="container">
		...
		<div class="well bs-component">
			<form class="form-horizontal" method="post">
				<fieldset>
					<legend>Product Regist</legend>
					<div class="form-group">
						<label class="col-lg-2 control-label" for="inputEmail">Product Name</label>
						<div class="col-lg-10">
							<input type="text" name="product_name" placeholder="Product Name" id="inputEmail" class="form-control">
						</div>
					</div>
					<div class="form-group">
